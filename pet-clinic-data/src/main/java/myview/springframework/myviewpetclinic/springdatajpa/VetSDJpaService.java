...
import myview.springframework.myviewpetclinic.repositories.VetRepository;
...
public class VetSDJpaService implements VetService {
    ...
    public Set<Vet> findAll() {
        ...
        //Looping through and adding the values in the set and then returning
    ...
    public Vet findById(Long id) {
        //Optional implementation shortcut
